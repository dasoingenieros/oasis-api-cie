...
const itc_bt_24_1 = require("../tables/itc-bt-24");
// ════════════════════════════════════════════════════════════════════════════
// Constantes
// ════════════════════════════════════════════════════════════════════════════
describe("ITC-BT-24 — Constantes", () => {
    it("NETWORK_VOLTAGE fase-neutro 230V, fase-fase 400V", () => {
        expect(itc_bt_24_1.NETWORK_VOLTAGE.phase_neutral).toBe(230);
        expect(itc_bt_24_1.NETWORK_VOLTAGE.phase_phase).toBe(400);
    });
    it("CONDUCTOR_MAX_TEMP_C: PVC 70, XLPE/EPR 90", () => {
        expect(itc_bt_24_1.CONDUCTOR_MAX_TEMP_C.PVC).toBe(70);
        expect(itc_bt_24_1.CONDUCTOR_MAX_TEMP_C.XLPE).toBe(90);
        expect(itc_bt_24_1.CONDUCTOR_MAX_TEMP_C.EPR).toBe(90);
    });
    it("TYPICAL_NETWORK_IMPEDANCE tiene urban_residential, rural, etc", () => {
        expect(itc_bt_24_1.TYPICAL_NETWORK_IMPEDANCE.urban_residential).toBeDefined();
        expect(itc_bt_24_1.TYPICAL_NETWORK_IMPEDANCE.urban_residential?.maxIccKA).toBe(6);
        expect(itc_bt_24_1.TYPICAL_NETWORK_IMPEDANCE.rural).toBeDefined();
    });
});
// ════════════════════════════════════════════════════════════════════════════
...
describe("ITC-BT-24 — calculateLoopImpedance", () => {
    it("calcula impedancia de bucle con valores por defecto", () => {
        const r = (0, itc_bt_24_1.calculateLoopImpedance)({
            sectionMm2: 2.5,
    ...
    it("Aluminio aumenta impedancia vs Cu", () => {
        const rCu = (0, itc_bt_24_1.calculateLoopImpedance)({
            sectionMm2: 6,
            protectionSectionMm2: 6,
            lengthM: 20,
            material: "Cu",
        ...
        const rAl = (0, itc_bt_24_1.calculateLoopImpedance)({
            sectionMm2: 6,
            protectionSectionMm2: 6,
            lengthM: 20,
            material: "Al",
...
describe("ITC-BT-24 — verifyIndirectContactProtection", () => {
    it("protegido cuando Uc ≤ 50V (local seco)", () => {
        const r = (0, itc_bt_24_1.verifyIndirectContactProtection)({
...
//# sourceMappingURL=itc-bt-24.test.js.map