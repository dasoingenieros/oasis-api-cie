...
describe("ITC-BT-17 — Constantes", () => {
    it("IGA_RATINGS_A contiene calibres normalizados", () => {
        expect(itc_bt_17_1.IGA_RATINGS_A).toContain(25);
        expect(itc_bt_17_1.IGA_RATINGS_A).toContain(40);
        expect(itc_bt_17_1.IGA_RATINGS_A).toContain(63);
        expect(itc_bt_17_1.IGA_RATINGS_A).toContain(400);
    });
    it("DIFFERENTIAL_SENSITIVITIES_MA contiene 30 y 300", () => {
        expect(itc_bt_17_1.DIFFERENTIAL_SENSITIVITIES_MA).toContain(30);
        expect(itc_bt_17_1.DIFFERENTIAL_SENSITIVITIES_MA).toContain(300);
    });
    it("CONTRACTED_POWERS_W contiene 5750 y 9200", () => {
        expect(itc_bt_17_1.CONTRACTED_POWERS_W).toContain(5750);
        expect(itc_bt_17_1.CONTRACTED_POWERS_W).toContain(9200);
    });
});
// ════════════════════════════════════════════════════════════════════════════
// selectIGARating
...
describe("ITC-BT-17 — selectIGARating", () => {
    it("monofásico 5750W → 25A", () => {
        const r = (0, itc_bt_17_1.selectIGARating)({ contractedPowerW: 5750, phaseSystem: "single" });
        expect(r.ratingA).toBe(25);
        expect(r.nominalCurrentA).toBeCloseTo(25, 0);
    });
    it("monofásico 9200W → 40A", () => {
        const r = (0, itc_bt_17_1.selectIGARating)({ contractedPowerW: 9200, phaseSystem: "single" });
        expect(r.ratingA).toBe(40);
    });
    it("monofásico con powerFactor < 1 aumenta In", () => {
        const r = (0, itc_bt_17_1.selectIGARating)({ contractedPowerW: 9200, phaseSystem: "single", powerFactor: 0.9 });
        expect(r.nominalCurrentA).toBeGreaterThan(40);
        expect(r.ratingA).toBe(50);
    });
    it("trifásico 34641W → 50A", () => {
        const r = (0, itc_bt_17_1.selectIGARating)({ contractedPowerW: 34641, phaseSystem: "three" });
        expect(r.ratingA).toBe(50);
    });
    it("trifásico 43301W → 63A", () => {
        const r = (0, itc_bt_17_1.selectIGARating)({ contractedPowerW: 43301, phaseSystem: "three" });
        expect(r.ratingA).toBe(63);
    });
    it("voltageV personalizado afecta In", () => {
        const r = (0, itc_bt_17_1.selectIGARating)({
    ...
    it("potencia muy alta devuelve último calibre", () => {
        const r = (0, itc_bt_17_1.selectIGARating)({ contractedPowerW: 500000, phaseSystem: "three" });
...
describe("ITC-BT-17 — getRequiredDifferentials", () => {
    it("devuelve 2 diferenciales para vivienda", () => {
        const r = (0, itc_bt_17_1.getRequiredDifferentials)({
            phaseSystem: "single",
...
describe("ITC-BT-17 — getProtectionConductorSection", () => {
    it("S ≤ 16: PE = S", () => {
        expect((0, itc_bt_17_1.getProtectionConductorSection)(1.5)).toBe(1.5);
        expect((0, itc_bt_17_1.getProtectionConductorSection)(6)).toBe(6);
        expect((0, itc_bt_17_1.getProtectionConductorSection)(16)).toBe(16);
    });
    it("16 < S ≤ 35: PE = 16", () => {
        expect((0, itc_bt_17_1.getProtectionConductorSection)(25)).toBe(16);
        expect((0, itc_bt_17_1.getProtectionConductorSection)(35)).toBe(16);
    });
    it("S > 35: PE = S/2 redondeado", () => {
        expect((0, itc_bt_17_1.getProtectionConductorSection)(50)).toBe(25);
        expect((0, itc_bt_17_1.getProtectionConductorSection)(70)).toBe(35);
        expect((0, itc_bt_17_1.getProtectionConductorSection)(95)).toBe(48);
    });
});
// ════════════════════════════════════════════════════════════════════════════
...
describe("ITC-BT-17 — verifyProtectionCoordination", () => {
    it("coordina cuando Ib ≤ In ≤ Iz e I2 ≤ 1.45×Iz", () => {
        const r = (0, itc_bt_17_1.verifyProtectionCoordination)({ Ib: 10, In: 16, Iz: 21 });
    ...
    it("condición 1 falla si Ib > In", () => {
        const r = (0, itc_bt_17_1.verifyProtectionCoordination)({ Ib: 20, In: 16, Iz: 25 });
        expect(r.condition1.ok).toBe(false);
        expect(r.isCoordinated).toBe(false);
    });
    it("condición 1 falla si In > Iz", () => {
        const r = (0, itc_bt_17_1.verifyProtectionCoordination)({ Ib: 10, In: 25, Iz: 16 });
        expect(r.condition1.ok).toBe(false);
        expect(r.isCoordinated).toBe(false);
    });
    it("condición 2 falla si I2 > 1.45×Iz", () => {
        const r = (0, itc_bt_17_1.verifyProtectionCoordination)({ Ib: 5, In: 25, Iz: 20 });
        expect(r.condition2.ok).toBe(false);
        expect(r.isCoordinated).toBe(false);
    });
    it("I2factor personalizado", () => {
        const r = (0, itc_bt_17_1.verifyProtectionCoordination)({
            Ib: 10,
            In: 16,
            Iz: 25,
            I2factor: 2.0,
    ...
    it("I2factor por defecto 1.45", () => {
        const r = (0, itc_bt_17_1.verifyProtectionCoordination)({ Ib: 10, In: 20, Iz: 30 });
        expect(r.condition2.I2).toBeCloseTo(20 * 1.45, 0);
    });
});
//# sourceMappingURL=itc-bt-17.test.js.map