...
const nominal_current_1 = require("../calculations/nominal-current");
...
describe("calculateNominalCurrent", () => {
    ...
    describe("monofásico", () => {
        it("calcula C1 alumbrado: 2300W, cosφ=1, 230V", () => {
            const result = (0, nominal_current_1.calculateNominalCurrent)({
                phaseSystem: "single",
                loadPowerW: 2300,
                powerFactor: 1.0,
            });
    ...
    describe("errores de validación", () => {
        it("lanza EngineError para potencia 0", () => {
            expect(() => (0, nominal_current_1.calculateNominalCurrent)({
                phaseSystem: "single",
                loadPowerW: 0,
                powerFactor: 1.0,
            })).toThrow(types_1.EngineError);
        });
        ...
        it("el error incluye el circuitId si se proporciona", () => {
            try {
                (0, nominal_current_1.calculateNominalCurrent)({
                    phaseSystem: "single",
                    loadPowerW: 0,
                    powerFactor: 1.0,
                    circuitId: "C1-salon",
                ...
                expect(e.circuitId).toBe("C1-salon");
            }
        });
        it("NUNCA produce NaN", () => {
            ...
            const result = (0, nominal_current_1.calculateNominalCurrent)(safeInput);
...
describe("getAdmissibleCurrent (ITC-BT-19)", () => {
    describe("Cobre PVC — valores críticos de tabla", () => {
        it("A1 / 1.5mm² / PVC / Cu = 13A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("A1", 1.5, "PVC", "Cu")).toBe(13);
        });
        it("A1 / 2.5mm² / PVC / Cu = 17.5A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("A1", 2.5, "PVC", "Cu")).toBe(17.5);
        });
        it("B1 / 6mm² / PVC / Cu = 36A (circuito C3 cocina)", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("B1", 6, "PVC", "Cu")).toBe(36);
        });
        it("C / 16mm² / PVC / Cu = 76A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("C", 16, "PVC", "Cu")).toBe(76);
        });
        it("E / 50mm² / PVC / Cu = 168A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("E", 50, "PVC", "Cu")).toBe(168);
        });
    });
    describe("Cobre XLPE — valores críticos", () => {
        it("A1 / 1.5mm² / XLPE / Cu = 15.5A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("A1", 1.5, "XLPE", "Cu")).toBe(15.5);
        });
        it("B2 / 4mm² / XLPE / Cu = 31A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("B2", 4, "XLPE", "Cu")).toBe(31);
        });
        it("C / 25mm² / XLPE / Cu = 119A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("C", 25, "XLPE", "Cu")).toBe(119);
        });
        it("F / 240mm² / XLPE / Cu = 641A (línea principal)", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("F", 240, "XLPE", "Cu")).toBe(641);
        });
    });
    describe("Aluminio", () => {
        it("C / 16mm² / PVC / Al = 59A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("C", 16, "PVC", "Al")).toBe(59);
        });
        it("D / 95mm² / XLPE / Al = 199A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("D", 95, "XLPE", "Al")).toBe(199);
        });
    });
    describe("EPR — trata igual que XLPE", () => {
        it("A1 / 1.5mm² / EPR / Cu = igual que XLPE = 15.5A", () => {
            expect((0, itc_bt_19_1.getAdmissibleCurrent)("A1", 1.5, "EPR", "Cu")).toBe(15.5);
        });
    });
    describe("Errores", () => {
        it("lanza error para sección no existente en tabla", () => {
            expect(() => (0, itc_bt_19_1.getAdmissibleCurrent)("A1", 3, "PVC", "Cu")).toThrow();
        });
        it("lanza error para método inválido", () => {
            // @ts-expect-error — probando input inválido en runtime
            expect(() => (0, itc_bt_19_1.getAdmissibleCurrent)("Z1", 2.5, "PVC", "Cu")).toThrow();
        });
    });
    describe("getAvailableSections", () => {
        it("A1/PVC/Cu devuelve 16 secciones", () => {
            const sections = (0, itc_bt_19_1.getAvailableSections)("A1", "PVC", "Cu");
        ...
        it("A1/PVC/Al devuelve solo secciones ≥ 16mm²", () => {
            const sections = (0, itc_bt_19_1.getAvailableSections)("A1", "PVC", "Al");
            expect(sections.every(s => s >= 16)).toBe(true);
        });
        it("devuelve secciones ordenadas ascendentemente", () => {
            const sections = (0, itc_bt_19_1.getAvailableSections)("C", "XLPE", "Cu");
...
describe("Factores de corrección", () => {
    describe("getCorrectionFactorCa — temperatura ambiente", () => {
        it("PVC / 40°C = 0.87 (temperatura base ITC-BT-19)", () => {
            expect((0, correction_factors_1.getCorrectionFactorCa)("PVC", 40)).toBeCloseTo(0.87, 2);
        });
        it("XLPE / 40°C = 0.91", () => {
            expect((0, correction_factors_1.getCorrectionFactorCa)("XLPE", 40)).toBeCloseTo(0.91, 2);
        });
        it("PVC / 25°C — interpolación", () => {
            // Entre 20°C (1.12) y 30°C (1.00): 25°C → 1.06
            expect((0, correction_factors_1.getCorrectionFactorCa)("PVC", 25)).toBeCloseTo(1.06, 2);
        });
        it("Ca < 1 cuando temperatura > temperatura de referencia tabla", () => {
            const ca50 = (0, correction_factors_1.getCorrectionFactorCa)("PVC", 50);
            expect(ca50).toBeLessThan(1.0);
        });
        it("Ca > 1 cuando temperatura < temperatura de referencia tabla", () => {
            const ca20 = (0, correction_factors_1.getCorrectionFactorCa)("PVC", 20);
            expect(ca20).toBeGreaterThan(1.0);
        });
        it("nunca devuelve NaN", () => {
            expect(isNaN((0, correction_factors_1.getCorrectionFactorCa)("PVC", 40))).toBe(false);
            expect(isNaN((0, correction_factors_1.getCorrectionFactorCa)("XLPE", 90))).toBe(false);
        });
    });
    describe("getCorrectionFactorCg — agrupamiento", () => {
        it("1 circuito = 1.0", () => {
            expect((0, correction_factors_1.getCorrectionFactorCg)(1, "B1")).toBe(1.0);
        });
        it("3 circuitos = 0.70", () => {
            expect((0, correction_factors_1.getCorrectionFactorCg)(3, "B1")).toBe(0.70);
        });
        it("6 circuitos = 0.57", () => {
            expect((0, correction_factors_1.getCorrectionFactorCg)(6, "C")).toBe(0.57);
        });
        it("método D siempre devuelve 1.0 (enterrados)", () => {
            expect((0, correction_factors_1.getCorrectionFactorCg)(5, "D")).toBe(1.0);
            expect((0, correction_factors_1.getCorrectionFactorCg)(20, "D")).toBe(1.0);
        });
        it("siempre < 1 para n > 1 en métodos no enterrados", () => {
            expect((0, correction_factors_1.getCorrectionFactorCg)(2, "B1")).toBeLessThan(1.0);
            expect((0, correction_factors_1.getCorrectionFactorCg)(10, "C")).toBeLessThan(1.0);
        });
    });
    describe("getCorrectionFactorCt — resistividad terreno", () => {
        it("2.5 K·m/W (referencia) = 1.0", () => {
            expect((0, correction_factors_1.getCorrectionFactorCt)(2.5)).toBeCloseTo(1.0, 2);
        });
        it("1.0 K·m/W (suelo húmedo) > 1.0", () => {
            expect((0, correction_factors_1.getCorrectionFactorCt)(1.0)).toBeGreaterThan(1.0);
        });
        it("4.0 K·m/W (suelo seco) < 1.0", () => {
            expect((0, correction_factors_1.getCorrectionFactorCt)(4.0)).toBeLessThan(1.0);
        });
    });
    describe("getCorrectionFactors — combinado", () => {
        it("condiciones normales: combined ≈ Ca × Cg", () => {
            const result = (0, correction_factors_1.getCorrectionFactors)({
                insulationType: "PVC",
                ambientTempC: 40,
                groupingCircuits: 3,
                method: "B1",
...
//# sourceMappingURL=nominal-current.test.js.map