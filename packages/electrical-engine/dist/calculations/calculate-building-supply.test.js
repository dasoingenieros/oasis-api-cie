...
const calculate_building_supply_1 = require("./calculate-building-supply");
describe("calculateBuildingSupply — Edificio multivivienda", () => {
    ...
    describe("Previsión de cargas (ITC-BT-10)", () => {
        it("10 viviendas básicas: coeff 7.38, total = 7.38 × 5750W", () => {
            const result = (0, calculate_building_supply_1.calculateBuildingSupply)(baseInput);
        ...
        it("20 viviendas elevadas: coeff 12.18, total = 12.18 × 9200W", () => {
            const result = (0, calculate_building_supply_1.calculateBuildingSupply)({
                ...baseInput,
                nDwellings: 20,
    ...
    describe("LGA (ITC-BT-14)", () => {
        ...
        it("LGA larga (50m): incrementa sección para cumplir CdT", () => {
            const shortResult = (0, calculate_building_supply_1.calculateBuildingSupply)({ ...baseInput, lgaLengthM: 5 });
            const longResult = (0, calculate_building_supply_1.calculateBuildingSupply)({ ...baseInput, lgaLengthM: 50 });
    ...
    describe("Validación global", () => {
        ...
        it("warnings vacíos en caso normal", () => {
            ...
            const criticalWarnings = result.warnings.filter(w => w.includes("supera") || w.includes("inferior"));
...
//# sourceMappingURL=calculate-building-supply.test.js.map