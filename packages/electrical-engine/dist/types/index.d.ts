...
export type CircuitCode = "C1" | "C2" | "C3" | "C4" | "C4.1" | "C4.2" | "C4.3" | "C5" | "C6" | "C7" | "C8" | "C9" | "C10" | "C11" | "C12" | "CUSTOM";
/** Tipo instalación interior — ITC-BT-26 */
export type InstallationTypeItcBt26 = "E.T.F." | "E.T.C." | "S.T.C." | "S.T.R." | "S.C.P." | "S.C.P.F.";
/** Tipo instalación enlace — ITC-BT-20 */
export type InstallationTypeItcBt20 = "T.P." | "F.D.P." | "ENTR." | "D.E.E." | "AERO" | "I.H.C." | "C.P." | "MOLD." | "BANDJ." | "C.E.P.";
/** Tensión nominal de aislamiento del cable */
export type InsulationVoltage = "450/750V" | "0.6/1kV";
