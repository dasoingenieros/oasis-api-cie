...
exports.REACTANCE_TABLE_CABLE = exports.TEMP_COEFF = exports.RESISTIVITY_20C = exports.LGA_SECTION_TABLE = void 0;
exports.getResistivityAtTemp = getResistivityAtTemp;
exports.calculateLGAVoltageDrop = calculateLGAVoltageDrop;
exports.getNeutralSection = getNeutralSection;
/**
 * Tabla de secciones mínimas para LGA según intensidad máxima prevista.
 * ITC-BT-14 §3 / IEC 60364-5-52
 */
exports.LGA_SECTION_TABLE = [
 ...
 * ρ_T = ρ_20 × [1 + α × (T - 20)]
 */
function getResistivityAtTemp(material, tempC) {
    const rho20 = exports.RESISTIVITY_20C[material];
    const alpha = exports.TEMP_COEFF[material];
 ...
 */
function calculateLGAVoltageDrop(input) {
    ...
    const X_mOhm_per_m = exports.REACTANCE_TABLE_CABLE[input.sectionMm2] ?? 0;
 ...
 */
function getNeutralSection(phaseSectionMm2, material) {
    if (material === "Cu") {
        ...
        // Aluminio
        if (phaseSectionMm2 <= 25)
            return phaseSectionMm2;
        return Math.max(phaseSectionMm2 / 2, 16);
    }
}
//# sourceMappingURL=itc-bt-14.js.map