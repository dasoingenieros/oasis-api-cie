...
exports.MOTOR_POWER_FACTOR_TYPICAL = exports.MOTOR_EFFICIENCY_TYPICAL = exports.MOTOR_START_TYPES = void 0;
exports.calculateMotorCurrent = calculateMotorCurrent;
exports.getMotorDesignCurrent = getMotorDesignCurrent;
const types_1 = require("../types");
exports.MOTOR_START_TYPES = {
    direct: {
        type: "direct",
...
exports.MOTOR_EFFICIENCY_TYPICAL = {
...
exports.MOTOR_POWER_FACTOR_TYPICAL = {
    // A plena carga
    0.25: 0.70,
    0.55: 0.72,
    0.75: 0.75,
 ...
 * ITC-BT-47 §2 y §3
 */
function calculateMotorCurrent(input) {
    ...
    const eta = input.efficiency ?? (exports.MOTOR_EFFICIENCY_TYPICAL[P_kW] ?? 0.88);
    const cosφ = input.powerFactor ?? (exports.MOTOR_POWER_FACTOR_TYPICAL[P_kW] ?? 0.85);
    ...
    const startSpec = exports.MOTOR_START_TYPES[startType];
    const startCurrentA = In * startSpec.startCurrentFactor.max;
    // PIA mínimo para Ib_diseño
    const minPIA = types_1.NORMALIZED_BREAKER_RATINGS.find(r => r >= Ib_design) ?? 250;
    // Advertencias
 ...
 */
function getMotorDesignCurrent(nominalCurrentA) {
    return nominalCurrentA * 1.25;
}
//# sourceMappingURL=itc-bt-47.js.map