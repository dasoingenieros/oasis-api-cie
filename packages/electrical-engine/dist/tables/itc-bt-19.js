...
exports.ITC_BT_19_CURRENT_TABLE_AL = exports.ITC_BT_19_CURRENT_TABLE_CU = void 0;
exports.getAdmissibleCurrent = getAdmissibleCurrent;
exports.getAvailableSections = getAvailableSections;
// ─── TABLA PRINCIPAL (Cobre, corriente alterna) ───────────────────────────
// Valores en Amperios
exports.ITC_BT_19_CURRENT_TABLE_CU = {
...
exports.ITC_BT_19_CURRENT_TABLE_AL = {
    A1: {
        PVC: {
            16: 40,
            25: 53,
 ...
 */
function getAdmissibleCurrent(method, sectionMm2, insulation, material = "Cu") {
    ...
    const insulationKey = insulation === "PVC" ? "PVC" : "XLPE";
    const insulationTable = methodTable[insulationKey];
    const value = insulationTable[sectionMm2];
    if (value === undefined) {
        throw new Error(`ITCBT19_SECTION_NOT_FOUND: Sección ${sectionMm2}mm² no disponible para método ${method}/${material}/${insulation}. ` +
 ...
 */
function getAvailableSections(method, insulation, material = "Cu") {
    const table = material === "Cu"
        ? exports.ITC_BT_19_CURRENT_TABLE_CU
        : exports.ITC_BT_19_CURRENT_TABLE_AL;
    const insulationKey = insulation === "PVC" ? "PVC" : "XLPE";
...
//# sourceMappingURL=itc-bt-19.js.map