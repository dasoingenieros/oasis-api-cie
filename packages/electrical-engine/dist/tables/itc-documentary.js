...
exports.SPECIAL_INSTALLATIONS = exports.INSTALLATION_METHOD_DESCRIPTIONS = exports.NETWORK_SYSTEMS = exports.VERIFICATION_TESTS = exports.DOCUMENTATION_REQUIREMENTS = exports.REBT_DEFINITIONS = void 0;
// ─── ITC-BT-01: Terminología ──────────────────────────────────────────────
exports.REBT_DEFINITIONS = {
    "Instalación eléctrica": "Conjunto de aparatos y circuitos asociados, en previsión de un fin particular: producción, conversión, transformación, transmisión, distribución o utilización de la energía eléctrica.",
    "Tensión nominal": "Tensión con que se designa una instalación o parte de ella, y que sirve, junto con la intensidad nominal u otras magnitudes, para designarla.",
    "Corriente de cortocircuito (Icc)": "Sobrecorriente resultante de un defecto de impedancia despreciable entre conductores activos que tienen diferente potencial en condiciones normales de funcionamiento.",
    "Intensidad admisible (Iz)": "Valor de la corriente eléctrica continua, que puede transportar un conductor en condiciones de servicio especificadas sin que su temperatura en régimen permanente supere un valor especificado.",
    "Caída de tensión (CdT)": "Diferencia algebraica entre las tensiones en dos puntos de un circuito, en condiciones de funcionamiento.",
    "Diferencial (ID)": "Dispositivo destinado a la protección de las personas contra los choques eléctricos por contactos indirectos.",
    "PIA": "Pequeño Interruptor Automático. Dispositivo de protección contra sobreintensidades (sobrecargas y cortocircuitos) de uso doméstico.",
    "CGMP": "Cuadro General de Mando y Protección. Cuadro en el que se ubican los dispositivos de mando y protección de los circuitos interiores de la instalación.",
    "Derivación individual (DI)": "Parte de la instalación que, partiendo de la línea general de alimentación (LGA) o de los fusibles de seguridad, suministra energía eléctrica a un usuario.",
    "LGA": "Línea General de Alimentación. Parte de la instalación comprendida entre la Caja General de Protección (CGP) y el equipo de medida.",
};
exports.DOCUMENTATION_REQUIREMENTS = [
    {
...
exports.INSTALLATION_METHOD_DESCRIPTIONS = {
...
//# sourceMappingURL=itc-documentary.js.map