// src/installations/field-config/elevacion.ts
// Perfil ELEVACION — elevacion y transporte (ascensores, gruas, etc.).
// SIEMPRE Proyecto (ITC-BT-04 grupo j).
...
const TECNICO_FIELDS: FieldDef[] = [
  ...
  },
  {
    ...
    defaultValue: 'Elevacion y transporte',
    inputType: 'text',
...
export const ELEVACION_FIELDS: FieldDef[] = [
  ...TITULAR_FIELDS,
  ...EMPLAZAMIENTO_DIRECCION_FIELDS,
  ...EMPLAZAMIENTO_EXTRAS_FIELDS,
  ...TECNICO_FIELDS,
