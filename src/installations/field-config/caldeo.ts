// src/installations/field-config/caldeo.ts
// Perfil CALDEO — conductores aislados caldeo (grupo c).
// supplyVoltage default 230. superficieM2: A (obligatorio).
// MTD si P <= 10kW.
...
const TECNICO_FIELDS: FieldDef[] = [
  ...
  },
  {
    ...
    defaultValue: 'Conductores aislados caldeo',
    inputType: 'text',
...
export const CALDEO_FIELDS: FieldDef[] = [
  ...TITULAR_FIELDS,
  ...EMPLAZAMIENTO_DIRECCION_FIELDS,
  ...EMPLAZAMIENTO_EXTRAS_FIELDS,
  ...TECNICO_FIELDS,
