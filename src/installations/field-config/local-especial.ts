// src/installations/field-config/local-especial.ts
// Perfil LOCAL_ESPECIAL — local especial, bombas (grupo j).
// SIEMPRE Proyecto. supplyVoltage default 400.
...
export const LOCAL_ESPECIAL_FIELDS: FieldDef[] = [
  ...TITULAR_FIELDS,
  ...EMPLAZAMIENTO_DIRECCION_FIELDS,
  ...EMPLAZAMIENTO_EXTRAS_FIELDS,
  ...TECNICO_FIELDS,
