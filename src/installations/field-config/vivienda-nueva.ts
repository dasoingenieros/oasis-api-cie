...
export const VIVIENDA_NUEVA_FIELDS: FieldDef[] = [
  ...
  },
  {
    ...
    label: 'Tipo via',
    inputType: 'select',
    options: ['Calle', 'Avenida', 'Plaza', 'Paseo', 'Camino', 'Carretera', 'Travesia', 'Ronda', 'Glorieta', 'Urbanizacion'],
    requiredForDocs: ['MTD', 'CIE', 'SOLICITUD_BT'],
  },
  {
  ...
  // ═══ DERIVACION INDIVIDUAL ═══
  {
    ...
    calculatedBy: 'motor: max(tabla, CdT, usuario)',
    requiredForDocs: ['MTD', 'CIE'],
  },
  {
    name: 'cdtDi',
    group: 'C',
    section: 'di',
    label: 'Caida de tension DI (%)',
    calculatedBy: 'formula: (2xIxLxR)/(VxS)',
    requiredForDocs: ['MTD'],
  },
  {
    name: 'materialDi',
  ...
  {
    name: 'numDerivaciones',
    group: 'C',
    section: 'di',
    label: 'Numero de derivaciones',
    calculatedBy: 'motor',
    requiredForDocs: ['MTD'],
  },
  {
    ...
    group: 'C',
    section: 'di',
    label: 'Aislamiento DI',
    calculatedBy: 'motor',
    requiredForDocs: ['MTD'],
  },
  {
    name: 'tipoInstalacionDi',
    group: 'C',
    section: 'di',
    label: 'Metodo instalacion DI',
    calculatedBy: 'motor',
    requiredForDocs: ['MTD'],
  },
